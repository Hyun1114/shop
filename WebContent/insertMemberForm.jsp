...
%>
		...
		<form id="joinForm" action="<%=request.getContextPath() %>/insertMemberAction.jsp" method="post" class=".custom-select">	
			...
			<div class="text-white"><input type="password" id="memberPw" name="memberPw"></div>
			
			<!-- 회원 이름 -->
			<div class="text-white">이름 : </div>
			<div class="text-white"><input type="text" id="memberName" name="memberName"></div>
			...
			<br><button class="btn btn-success" id="btn" type="button">회원가입</button>
